...
<form method="post" action="https://emile-lenain.students-laplateforme.io/recette-idr.php">
    ...
    <button type="button" onclick="window.location.href='https://emile-lenain.students-laplateforme.io/user.php'">Ecran des plats</button>
</form>
</body>
</html>
...
?>
<img src="https://emile-lenain.students-laplateforme.io" alt="recette" width="500" height="300">
